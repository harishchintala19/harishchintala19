![Profile Views](https://komarev.com/ghpvc/?username=harishchintala&color=green)

# 👋 Hi, I'm Harish Chintala


Senior SDET Engineer with 5 years of experience in building scalable automation solutions across web, mobile, and device platforms. Skilled in designing robust UI and API test frameworks, integrating automation into CI/CD pipelines, and improving test reliability, coverage, and execution speed.

Experienced in performance optimization, strategic test planning, and modern QA engineering practices. Passionate about leveraging AI-assisted testing, intelligent automation, and data-driven quality insights to deliver faster, smarter, and more reliable software releases.
...
### 🔌 API Testing
![Rest Assured](https://img.shields.io/badge/Rest_Assured-6DB33F?style=flat-square&logo=spring&logoColor=white)
